 ...
 *
 *   <div className="bda-card" aria-busy={query.data === undefined}>
 */
...
/** Stands in for a `.bda-metric`: the big number and its label. */
...
/**
 * Stands in for a `<DataTable>`, header row included.
 *
 * `columns` and `rows` should match what the query returns, so the card does
